...
namespace ZenitharClient.Src
{
    internal class Config
    {
        ...
        {
            return !string.IsNullOrWhiteSpace(GuildToken) && !string.IsNullOrWhiteSpace(ServerEndpoint);
        }
        ...
        internal string? ServerEndpoint
        {
            get => data.ServerEndpoint;
            set => data.ServerEndpoint = value;
        }
    }
}